...
public class TwoDimArrayPractice extends JFrame
{
  ...
  // end of printArray method (Done Correctly.)
   ...
   */
   public void setValues( int value, int row2 )
   {
    // Note:  To animate the algorithm, put this method call as the
   ...
   */
   public int findMinimum( int column2 )
   {
    // Note:  To animate the algorithm, put this method call as the
    // last element in your for loop
	        ...
	        for ( int column = 0; column < intArray[row].length; column++ )
	        {
	        	...
	        	if(column == column2) {
	        		...
	        		if(minimum > intArray[row][column]){
	        			...
	        			animate( row, column, minimum );  // needed to create visual feedback
	   ...
	   for ( int row = 0; row < intArray.length; row++ )
	    {
	        ...
	        for ( int column = 0; column < intArray[row].length; column++ )
	        {
	          if(value == intArray[row][column]) {
	        	  count++;
	          }
	          animate( row, column, count );  // needed to create visual feedback
	        }
